...
class _InsertManagerState extends State<ProfileScreen> {
  ...
  void signUp(String email, String password, String name, String number, String rool) async {
    ...
    if (key.currentState!.validate()) {
      try {
        ...
        await postDetailsToFirestore(email, password, name, number, rool);
      } catch (e) {
        showDialog(
          context: context,
  ...
  postDetailsToFirestore(String email, String password, String name, String number, String role) async {
    FirebaseFirestore firebaseFirestore = FirebaseFirestore.instance;
    var user = _auth.currentUser;
    CollectionReference ref = FirebaseFirestore.instance.collection('admin');
    // Use the document ID as the first argument in set()
    ...
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => ItemListManager()));
  }
