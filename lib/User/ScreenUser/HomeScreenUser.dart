import 'package:ayrastore/Admin/Screen/LoginScreen/SplashScreen.dart';
...
import 'DisplayInfomation.dart';
import 'faqScreen.dart';
import '../../Admin/Screen/CRUD/NotificationScreenAdmin.dart';
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => DisplayInfomation(
              ...
              price: item['price'] != null ? '${item['price']}' : 'Price not available',
              detail: item['detail'] ?? 'No Detail',
              features: item['dimensions'] is List<dynamic> ? item['dimensions'] : [item['dimensions']], // Ensure dimensions is a list
              ...
              icon: Stack(
                children: [
                  ...
                  StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection('user').doc(currentUserUid).collection('notification').snapshots(),
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                filteredItems =
                    filteredItems.where((item) => searchByBrand(item)).toList();
